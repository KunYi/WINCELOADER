...
;
    ...
    Packet_Sec       db  00h             ; 7C14  20      1
                     ...
                     db  00h             ; 7C1A  26      1
                     db  00h             ; 7C1B  27      1
    BackToZero times 36 db  0            ; 7C1C  28      36
    PartOffsetLL     dw  0000h           ; 7C40  64      2
    PartOffsetLH     dw  0000h           ; 7C42  66      2
    PartitionOffsetH dd  0               ; 7C44  68      4
    PartitionLength  dq  0               ; 7C48  72      8
    FATOffset        dd  0               ; 7C50  80      4
    FATLength        dd  0               ; 7C54  84      4
    ClusterHeapL     dw  0000h           ; 7C58  88      2
    ClusterHeapH     dw  0000h           ; 7C5A  90      2
    ClusterCount     dd  0               ; 7C5C  92      4
    RootStartL       dw  0000h           ; 7C60  96      2
    RootStartH       dw  0000h           ; 7C62  98      2
    SerialNumber     dd  0               ; 7C64  100     4
...
_7C78:
    ...
    ;
    XOR     AX, AX
    MOV     AX,WORD [PartOffsetLL]
    MOV     DX,WORD [PartOffsetLH]
    ADD     AX,WORD [ClusterHeapL]
    ADC     DX,WORD [ClusterHeapH]

    ;
    ; BLDR is expecting to find the first data sector at this location, not
    ; the first sector of the root directory.
    ;
    MOV     WORD [_7C78+0BH],AX
    MOV     WORD [_7C78+0DH],DX

    ; Locate the first sector of the root directory
    ;
    MOV     AX, WORD [RootStartL]
    DEC     AX
    DEC     AX
    ...
    ADD     AX, WORD [_7C78+0BH]
    ADC     DX, WORD [_7C78+0DH]
    CALL    ReadSectorEx
    JB      DiskError
...
FindEntry:
    ...
    MOV     AL, BYTE [BX+3]    ; The stream name should only be 4 characters
    CMP     AL, 4
    JNE     EndFind
...
FoundFiles:
    ...
    SHL     BX, CL
    MUL     BX
    ADD     AX,WORD [_7C78+0BH] ; LBA
    ADC     DX,WORD [_7C78+0DH] ; LBA
...
Loop1:
    ...
    ;
    MOV     BX,WORD [_7C78+0BH]
    MOV     AX,WORD [_7C78+0DH]
...
ReadSectorEx:
    ...
    ;
ErrorMsg     DB  0DH, 0AH, 'Bad CE System Disk!', 0
ImageName    DB  'N', 00, 'W', 00, 'E', 00, 'C', 00, 'L', 00, 'D', 00, 'R', 00

...
_7C5A:
    ...
    XOR     AX, AX
    MOV     AL,[NumFATs]
    MUL     WORD [SectPerFATL]
    MOV     BX, AX
    MOV     CX, DX
    MOV     AL,[NumFATs]
    MUL     WORD [SectPerFATH]
    ...
    ; in FAT32.
    ;
    MOV     WORD [_7C5A+0BH],AX
    MOV     WORD [_7C5A+0DH],DX

    ; Locate the first sector of the root directory
    ;
    XOR     AX, AX
    MOV     AX, WORD [FirstClusterL]
    DEC     AX
    DEC     AX
    MUL     BYTE [SectPerClust]
    ...
    ADD     AX, WORD [_7C5A+0BH]
    ADC     DX, WORD [_7C5A+0DH]
    CALL    ReadSectorEx
    JB      DiskError
...
FoundFiles:
    ...
    XOR     BH,BH
    MUL     BX
    ADD     AX,WORD [_7C5A+0BH] ; LBA
    ADC     DX,WORD [_7C5A+0DH] ; LBA
...
Loop1:
    ...
    ;
    MOV     BX,WORD [_7C5A+0BH]
    MOV     AX,WORD [_7C5A+0DH]

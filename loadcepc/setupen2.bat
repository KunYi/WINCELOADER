...
:SHARE_PATH
if not exist \\boneyard\Developers\vc150.win\msvc goto ERROR
set __MSVCDIR=\\boneyard\Developers\vc150.win\msvc

@REM Setup PATH, DevDir, LIB, and INCLUDE locations.

:PATH_DONE
set PATH=%__MSVCDIR%\bin;%PATH%;%_WINCEROOT%\sdk\bin\i386\x86

...
;Running at FA00h 
        ...
        or		cl,[bp + 509]				; Saved byte right before 55AA sig
        jz		skip_spf_update				; CL was already 0
		mov		[bp + 36], cl
skip_spf_update:       
...
ErrorMsg    db  0Dh, 0Ah, 'Bad CE system disk.' 
ELSE
ErrorMsg    db  0Dh, 0Ah, 'Bad CE boot Disk' 
ENDIF
NewLine:
			db	0Dh, 0Ah, 0
	
BackupSecFATlb	db	0				;Saved copy of BPB[0x24]
